...
const BannerImage: FunctionComponent<BannerImageProps> = ({src, distance=0}) => { 

    const [scale, setScale] = useState<number>();
    const [dim, setDim] = useState<number>();

    function mapToSmoothValue(value: number, fromLow: number, fromHigh: number, toLow: number, toHigh: number): number {
