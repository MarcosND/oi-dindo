import { Box, Card, CardContent, Stack, Typography, CardMedia, IconButton, Dialog, DialogTitle, DialogContent, DialogContentText, Modal } from "@mui/material"
      ...
      <Stack>
        ...
        <Box sx={modalBottomBoxStyle}>
          ...
          <Stack direction="row" justifyContent={"center"} marginTop={2}>
            <SharingComponent shareUrl={"https://www.instagram.com/cantinhofilo/"} title={`Econtrei ${"Alfredo"} do ${"Cantinho da Filó"} pelo app Oi, Dindo!\n`} />
          </Stack>
        </Box>
      </Stack>
    </Modal>
